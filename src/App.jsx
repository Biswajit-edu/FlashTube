...
const App = () => {
  ...
  async function run(transcripted) {
    ...
    const prompt = `summarize the content within 300 words. first introduce what say is this video.summarize start with like "this video describe that like...". " ${transcripted}. " must be give as a one paragraph and must be in simple words.`;
